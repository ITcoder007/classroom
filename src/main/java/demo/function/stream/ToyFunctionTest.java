...
public class ToyFunctionTest {
    ...
    public static void main(String[] args) {
        ...
        String res = ToyFunctionTest.dateFormat(now, isoDateTime);
        ...
        // 匿名内部类 --简化--> Lambda 表达式
        toyFunction = (LocalDateTime dateTime, DateTimeFormatter dateTimeFormatter) -> ToyFunctionTest.dateFormat(dateTime, dateTimeFormatter);
        res = toyFunction.run(now, isoDateTime);
        System.out.println( res );

        // 函数方法引用
        toyFunction = ToyFunctionTest::dateFormat;
        res = toyFunction.run(now, isoDateTime);
        System.out.println( res );
